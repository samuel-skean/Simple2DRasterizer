...
- The hot dog color scheme does not appear on macOS, Fedora Asahi Remix 39 (under
  either Wayland or X11), or Windows 10. It is unknown on which platforms it does appear.
  Next steps:
  - Weep.

- Pop-ups and file-dialogs in Windows 10 have fuzzy text on a 4K monitor at 150%
  scaling.